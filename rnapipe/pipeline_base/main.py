...
import sys
from rnapipe.pipeline_base.config import Config
from rnapipe.pipeline_base.state import State
import rnapipe.pipeline_base.error_codes
import logging
# from rnapipe.pipeline_base.logger import Logger
...
def parse_command_line(version):
    ...
    parser = cmdline.get_argparse(description='RNA-Seq pipeline',
